...
CloudFileTemplates: Dict[str, str] = {}

CloudFileTemplates["interface_setup_script"] = """\
#!/bin/bash
cidr_to_net() {
...
class Cloud(Layer, Graphable):
    """!
    @brief The cloud layer.
    """
    ...
    def configure(self, emulator: Emulator):
        if self.__configured:
            self._log('This cloud layer has been configured before, skipping...')
            return
